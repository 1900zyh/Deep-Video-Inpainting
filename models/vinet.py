...
import math
from models.flow_modules import (WarpingLayer, LongFlowNetCorr, MaskEstimator_ )
from models.gated_conv import GatedConvolution, GatedUpConvolution
...
class VI_2D_Decoder_3(nn.Module):
    def __init__(self, opt):
        ...
        #### UPCONV
        self.dc1_1 = GatedUpConvolution((1, opt.size[1]//4//dv, opt.size[0]//4//dv), 128 , 96, kernel_size=(1,3,3), stride=(1,1,1), padding=(0,1,1), bias=False)
        ...
        #### UPCONV
        self.dc2_2 = GatedUpConvolution((1, opt.size[1]//2//dv, opt.size[0]//2//dv), 96, 64, kernel_size=(1,3,3), stride=(1,1,1), padding=(0,1,1), bias=False)
        ...
        #### UPCONV
        self.dc4 = GatedUpConvolution((1, opt.size[1]//dv, opt.size[0]//dv), 64 , 32, kernel_size=(1,3,3), stride=(1,1,1), padding=(0,1,1), bias=False)
...
class VINet_final(nn.Module):
    ...
    def forward(self, masked_img, mask, prev_state=None, prev_feed=None, idx=0): # masked img: b x C x TxHxW
        ...
        return pred, output, torch.stack([flow2_128,flow3_128,flow4_128,flow5_128, flow6_128],2), state, torch.stack([occ_mask, 1-occ_mask, occ_mask_64, 1-occ_mask_64, occ_mask_128, 1-occ_mask_128], 2), flow6_256
